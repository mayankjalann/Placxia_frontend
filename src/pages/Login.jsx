...
const Login = () => {
    ...
    return (
        <div className="flex-1 flex items-center justify-center p-4 relative min-h-[90vh]">
            
            <div className="w-full max-w-md bg-zinc-950 rounded-[2rem] p-10 border border-white/10 relative overflow-hidden">
                ...
                <h1 className="text-3xl font-bold text-white text-center mb-2 tracking-tight">Sign In</h1>
                <p className="text-zinc-500 text-center mb-8 font-medium">Access your curated archive.</p>
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                    <div className="space-y-2">
                        ...
                        <input 
                            ...
                            className="w-full px-5 py-4 bg-zinc-900 border border-white/10 rounded-xl text-white placeholder-zinc-600 focus:outline-none focus:border-white/30 transition-all"
                    ...
                    <button 
                        type="submit" 
                        className="w-full py-4 bg-white hover:bg-zinc-200 text-black font-medium rounded-full transition-colors flex items-center justify-center gap-2 mt-4"
                    >
                        Sign In
                    </button>
                </form>
